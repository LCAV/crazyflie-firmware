...
static EffectCall effects[] = {
    ...
    {.call = &siren}, //13
    {.call = &tilt}, //14
    {.call = &melodyplayer, .melody = &sweep}, // 15
    {.call = &melodyplayer, .melody = &sweep_low}, // 16
    {.call = &melodyplayer, .melody = &sweep_high}, // 17
    {.call = &melodyplayer, .melody = &sweep_all}, // 18
    {.call = &melodyplayer, .melody = &sweep_hard}, // 19
    {.call = &melodyplayer, .melody = &sweep_buzzer}, // 20
    {.call = &melodyplayer, .melody = &sweep_slow}, // 21
    {.call = &melodyplayer, .melody = &sweep_fast} // 22
